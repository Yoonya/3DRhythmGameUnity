...
public class StageMenu : MonoBehaviour
{
    ...
    public void BtnNext()
    {
        ...
        if (++currentSong > songList.Length - 1) //길이 벗어날시
            currentSong = 0;
        SettingSong();
    }
    ...
    public void BtnPlay()
    {
        ...
        GameManger.instance.GameStart(currentSong, t_bpm);
        this.gameObject.SetActive(false);
    }
}
